<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="Real_Estate.Update" EnableEventValidation="false" %>
...
<body>
    <h1 class="h1">Update Property</h1>
    <div class="forms">
...
<%--            <tr><td class="p">Property Location</td></tr>
         ...
         <%--   <tr><td class="p">Garden</td></tr>
            ...
            <tr><td class="p">Image 10</td></tr>
             ...
             <tr><th class="th"><asp:Button ID="Btn1" runat="server" Text="Submit" OnClick="update"  /></th></tr>
