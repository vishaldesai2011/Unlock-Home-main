...
namespace Real_Estate
{
    public partial class ShowProperty : System.Web.UI.Page
    {
        ...
        public void showProp()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * FROM property where u_name = @prop", con);
            cmd.Parameters.AddWithValue("@prop", Session["username"] as string);
            ...
            headerCell4.Text = "<font color='039BE5'>Action</font>";
