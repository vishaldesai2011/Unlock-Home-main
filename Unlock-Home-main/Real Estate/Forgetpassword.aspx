<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Forgetpassword.aspx.cs" Inherits="Real_Estate.Forgetpassword" %>
    ...
    <div class="container">
        ...
        <div class="right">
              ...
              <div class="form">
                  ...
                  <asp:Button ID="varify" runat="server" Text="Verify" OnClick="Click" /><br />
