<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Brokrage.aspx.cs" Inherits="Real_Estate.Brokrage" %>
        ...
        <div class="cust-nav">
         <ul>
            ...
            <%-- <asp:Label ID="Label3" CssClass="lbl" runat="server" Text=""></asp:Label>
             ...
             <li  class="active"><a class="active-a"  href="Brokrage.aspx">Brokrage</a></li>
