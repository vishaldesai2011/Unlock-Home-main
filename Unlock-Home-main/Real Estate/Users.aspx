<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="Real_Estate.Users" %>
        ...
        <div class="cust-nav">
         <ul>
            ...
            <%-- <asp:Label ID="Label3" CssClass="lbl" runat="server" Text=""></asp:Label>
             ...
             <li class="active"><a class="active-a" href="Admin_Users.aspx">Users</a></li>
